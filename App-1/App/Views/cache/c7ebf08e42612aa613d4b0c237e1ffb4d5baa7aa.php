    ...
    <div class=" container-fluid">
         <form method="post" action="checkAppointment">
            ...
            <div class="card mb-5">
                ...
                <button type="submit" class="btn btn-primary border-bottom btn-grad" name="showTime">Revisar
                    Horario</button>
                        ...
                        <div class="card shadow">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-items-center table-flush">
                                    ...
                                    <tbody>
<input class="form-control" type="hidden" name="id" value="<?php echo e($times[2][0]); ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" name="time[]"
                                                        value="6am" <?php if (isset($times[1])) {
                                                        $val=array_column($times[1], 2); foreach ($val as $item) { if
                                                        ($item=='6am' ) { echo 'checked' ; } } } ?>
                                                        id="Check-item1">
                                            ...
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" name="time[]"
                                                        value="6:20am" <?php if (isset($times[1])) {
                                                        $val=array_column($times[1], 2); foreach ($val as $item) { if
...
<?php echo $__env->make('doctor.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\citasProject\App\Views/doctor/checkAppointment.blade.php ENDPATH**/ ?>